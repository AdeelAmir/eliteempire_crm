...
<div class="modal fade" id="assignSelectedLeadModal" tabindex="200" role="dialog" aria-labelledby="assignSelectedLeadModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="assignSelectedLeadModalLabel">Assign Selected Leads</h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="__assignUsers" class="w-100">Users: <span
                                        class="__RemoveAllUsers float-right badge badge-info ml-2"
                                        style="cursor: pointer;">Clear</span> <span
                                        class="__SelectAllUsers float-right badge badge-info"
                                        style="cursor: pointer;">Select All</span></label>
                            <select multiple class="form-control ___assignUsers" name="__assignUsers[]" id="__assignUsers"
                                    required>
                                <?php
                                $Users = array();
