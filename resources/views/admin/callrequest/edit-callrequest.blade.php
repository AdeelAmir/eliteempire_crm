...
<div class="page-content" id="editCallRequest">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Dynamic Empire - <span class="text-primary">Edit Call Request</span></h4>
        </div>
...
@if($Role == 1)
<form action="{{url('admin/call-request/update')}}" method="post" id="editLeadForm" enctype="multipart/form-data">
    @elseif($Role == 2)
    <form action="{{url('general_manager/call-request/update')}}" method="post" id="editLeadForm" enctype="multipart/form-data">
        @elseif($Role == 3)
        <form action="{{url('confirmationAgent/call-request/update')}}" method="post" id="editLeadForm" enctype="multipart/form-data">
            @elseif($Role == 4)
            <form action="{{url('supervisor/call-request/update')}}" method="post" id="editLeadForm" enctype="multipart/form-data">
                @elseif($Role == 5)
                <form action="{{url('representative/call-request/update')}}" method="post" id="editLeadForm" enctype="multipart/form-data">
                    @endif
                    @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                       ...
                                       @if($Lead[0]->product == 1)
                                       <div class="col-md-3 mb-3 mt-3" id="_WindowsDoorsCountBlock">
                                           <label for="windows_doors_count">How many windows?</label>
                                           <input type="number" name="windows_doors_count" id="windows_doors_count" class="form-control" min="1" value="{{$Lead[0]->windows_doors_count}}" />
                                       </div>
                                       @else
                                       <div class="col-md-3 mb-3 mt-3" id="_WindowsDoorsCountBlock" style="display:none;">
                                           <label for="windows_doors_count">How many windows?</label>
                                           <input type="number" name="windows_doors_count" id="windows_doors_count" class="form-control" min="1" value="{{$Lead[0]->windows_doors_count}}" />
                                       </div>
                                       @endif
                                       ...
                                       @if($Lead[0]->product == 2)
                                       <div class="col-md-3 mb-3 mt-3" id="_OldRoofDurationBlock">
                                           <label for="old_roof_duration">How old is the roof?</label>
                                           <input type="number" name="old_roof_duration" id="old_roof_duration" class="form-control" min="1" value="{{$Lead[0]->old_roof}}" />
                                       </div>
                                       @else
                                       <div class="col-md-3 mb-3 mt-3" id="_OldRoofDurationBlock" style="display:none;">
                                           <label for="old_roof_duration">How old is the roof?</label>
                                           <input type="number" name="old_roof_duration" id="old_roof_duration" class="form-control" min="1" />
                                       </div>
                                       @endif
