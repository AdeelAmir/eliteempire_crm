...
@section('content')
    ...
    <div class="page-content" id="addNewRealtorPage">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Elite Empire - <span class="text-primary">Add Realtor Form</span></h4>
            </div>
        ...
        <form method="post" id="addRealtorForm" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <input type="submit"
                                                   ...
                                                   name="submitAddRealtorForm"
                                                   id="submitAddRealtorForm" value="Add"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
