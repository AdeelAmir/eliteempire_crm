...
@section('content')
    <div class="page-content" id="editRealtorPage">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Elite Empire - <span class="text-primary">Edit Realtor Form</span></h4>
            </div>
        ...
        <form method="post" id="editRealtorForm" enctype="multipart/form-data">
            @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mt-3">
                                            <label class="w-100" for="firstname"><strong>First Name</label>
                                        ...
                                        <div class="col-md-3 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="buisness_name" id="buisness_name"
                                                       value="{{$u_details[0]->buisnesss_name}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" id="ServingLocationBlock">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3 mb-2 mt-3">
                                                                <label class="w-100"
                                                                       for="propertyClassification_{{$ServingLocationCounter}}">Property
                                                                    Classification</label>
                                                                <select name="propertyClassification[]"
                                                                        id="propertyClassification_{{$ServingLocationCounter}}"
                                                                        class="form-control propertyClassification"
                                                                        multiple>
                                                                    <option value="">Select</option>
                                                                    <option value="residential" <?php if (in_array("residential", $_PropertyClassification)) {
                                                                        echo "selected";
                                                                    } ?> >Residential
                                                                    </option>
                                                                    <option value="commercial" <?php if (in_array("commercial", $_PropertyClassification)) {
                                                                        echo "selected";
                                                                    } ?> >Commercial
                                                                    </option>
                                                                    <option value="industrial" <?php if (in_array("industrial", $_PropertyClassification)) {
                                                                        echo "selected";
                                                                    } ?> >Industrial
                                                                    </option>
                                                                    <option value="agricultural" <?php if (in_array("agricultural", $_PropertyClassification)) {
                                                                        echo "selected";
                                                                    } ?> >Agricultural
                                                                    </option>
                                                                    <option value="vacant" <?php if (in_array("vacant", $_PropertyClassification)) {
                                                                        echo "selected";
                                                                    } ?> >Vacant Lot
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-3 mb-2 mt-3">
                                                                <label class="w-100"
                                                                       for="propertyType_{{$ServingLocationCounter}}">Property
                                                                    Type</label>
                                                                <select name="propertyType[]"
                                                                        id="propertyType_{{$ServingLocationCounter}}"
                                                                        class="form-control propertyType" multiple>
                                                                    <option value="">Select Property Type</option>
                                                                    <option value="singleFamily" <?php if (in_array("singleFamily", $_PropertyType)) {
                                                                        echo "selected";
                                                                    } ?> >Single Family
                                                                    </option>
                                                                    <option value="condominium" <?php if (in_array("condominium", $_PropertyType)) {
                                                                        echo "selected";
                                                                    } ?> >Condominium
                                                                    </option>
                                                                    <option value="townhouse" <?php if (in_array("townhouse", $_PropertyType)) {
                                                                        echo "selected";
                                                                    } ?> >Townhouse
                                                                    </option>
                                                                    <option value="multiFamily" <?php if (in_array("multiFamily", $_PropertyType)) {
                                                                        echo "selected";
                                                                    } ?> >Multi family
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-3 mb-2 mt-3">
                                                                <label class="w-100"
                                                                       for="multiFamilyType_{{$ServingLocationCounter}}">Multi-Family</label>
                                                                <select name="multiFamilyType[]"
                                                                        id="multiFamilyType_{{$ServingLocationCounter}}"
                                                                        class="form-control multiFamilyType" multiple>
                                                                    <option value="">Select</option>
                                                                    <option value="3_4_unit_or_5_plus" <?php if (in_array("3_4_unit_or_5_plus", $_MultiFamily)) {
                                                                        echo "selected";
                                                                    } ?> >3-4 Unit or 5 plus
                                                                    </option>
                                                                    <option value="duplexes" <?php if (in_array("duplexes", $_MultiFamily)) {
                                                                        echo "selected";
                                                                    } ?> >Duplexes
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-3 mb-2 mt-3">
                                                                <label class="w-100"
                                                                       for="constructionType_{{$ServingLocationCounter}}">Construction
                                                                    Type</label>
                                                                <select name="constructionType[]"
                                                                        id="constructionType_{{$ServingLocationCounter}}"
                                                                        class="form-control constructionType" multiple>
                                                                    <option value="">Select</option>
                                                                    <option value="wood" <?php if (in_array("wood", $_ConstructionType)) {
                                                                        echo "selected";
                                                                    } ?> >Wood
                                                                    </option>
                                                                    <option value="block" <?php if (in_array("block", $_ConstructionType)) {
                                                                        echo "selected";
                                                                    } ?> >Block
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="col-md-3 mb-3 mt-3">
                                                                <label class="w-100"
                                                                       for="state_{{$ServingLocationCounter}}">State</label>
                                                                <select class="form-control states"
                                                                        name="serving_state[]"
                                                                        id="state_{{$ServingLocationCounter}}"
                                                                        class="form-control"
                                                                        onchange="LoadServingLocationStateCountyCity(this.id);">
                                                                    <option value="">Select State</option>
                                                                    @foreach($states as $state)
                                                                        <option value="{{$state->name}}" <?php if ($s_loc->state == $state->name) {
                                                                            echo "selected";
                                                                        } ?> >{{$state->name}}</option>;
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-3 mb-3 mt-3">
                                                                <label class="w-100"
                                                                       for="zipcode_{{$ServingLocationCounter}}">Zip
                                                                    code</label>
                                                                <input type="text" name="serving_zipcode[]"
                                                                       value="{{$s_loc->zipcode}}"
                                                                       id="zipcode_{{$ServingLocationCounter}}"
                                                                       class="form-control"
                                            ...
                                            <span data-repeater-create=""
                                                  ...
                                                  id="remove_{{$ServingLocationCounter}}"
                                                  onclick="RemoveServingLocation(this.id);">
                                            ...
                                            @endforeach
                                            <input type="hidden" name="_servingLocationCounter"
                                                   id="_servingLocationCounter" value="{{$ServingLocationCounter}}"/>
                                        </div>
                                        <div class="col-md-12 mb-3 mt-3">
                                  <span data-repeater-create="" class="btn btn-outline-success btn-sm float-right"
                                        onclick="MakeEditServingLocation();">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right mt-3">
                                            <input type="submit"
                                                   ...
                                                   name="submitUpdateIRealtorForm"
                                                   id="submitUpdateIRealtorForm" value="Update"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
