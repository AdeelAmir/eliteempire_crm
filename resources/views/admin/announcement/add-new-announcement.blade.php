...
@section('content')
    <div class="page-content" id="addNewAnnouncementPage">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Elite Empire - <span class="text-primary">Add Announcement Form</span></h4>
            </div>
        ...
        @if(Session::get('user_role') == 1)
            <form action="{{url('admin/announcement/store')}}" method="post" id="addAnnouncementForm"
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right mt-3">
                                        <input type="submit" class="btn btn-primary w-10"
                                               name="submitAddAnnouncementForm"
                                               id="submitAddAnnouncementForm" value="Add"/>
                                    </div>
                                </div>
                            </div>
                        </div>
