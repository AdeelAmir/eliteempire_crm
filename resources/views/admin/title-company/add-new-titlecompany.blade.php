...
@section('content')
    ...
    <div class="page-content" id="addNewTitleCompanyPage">
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <div>
                <h4 class="mb-3 mb-md-0">Elite Empire - <span class="text-primary">Add Title Company Form</span></h4>
            </div>
        ...
        <form method="post" id="addTitleCompanyForm" enctype="multipart/form-data">
            @csrf
            <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3 mt-3">
                                            <div class="form-group">
                                                <label class="w-100" for="buisness_name">Buisness Address</label>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                      ...
                                      <span data-repeater-create="" class="btn btn-outline-success btn-sm float-right"
                                            onclick="MakeTitleCompanyServingLocation();">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right mt-3">
                                            <button type="button"
                                                    ...
                                                    name="backAddTitleCompanyForm"
                                                    id="backAddTitleCompanyForm"
                                                    onclick="displayBackGeneralInformationSection();">
                                                Back
                                            </button>
                                            <input type="submit"
                                                   class="btn btn-primary float-right w-10"
                                                   name="submitAddTitleCompanyForm"
                                                   id="submitAddTitleCompanyForm" value="Add"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
